usersRender = function () {
    ...
    $table.on("check.bs.table", function (e, row, value, index) {
        $.ajax({
            ...
            beforeSend: function (xhr) {
                ...
                $("#totalBuy").text("");
                $("#lastDay").text("");
                $("#card").removeClass("spinner-border spinner-border-sm text-primary");
                $("#card").addClass("spinner-border spinner-border-sm text-primary");
                $("#totalBuy").removeClass("spinner-border spinner-border-sm text-primary");
                $("#totalBuy").addClass("spinner-border spinner-border-sm text-primary");
                $("#totalCredit").removeClass("spinner-border spinner-border-sm text-primary");
                $("#lastDay").removeClass("spinner-border spinner-border-sm text-primary");
                $("#totalCredit").addClass("spinner-border spinner-border-sm text-primary");
                $("#lastDay").addClass("spinner-border spinner-border-sm text-primary");
            },
        })
            .done(function (msg) {
            $("#card").removeClass("spinner-border spinner-border-sm text-primary");
            ...
            var jc_5456464 = $.confirm({
                ...
                buttons: {
                    confirm: {
                        ...
                        btnClass: "btn-green",
                        action: function () {
                            postData("users/update", "PATCH", getFormData("userForm", { id: row.id }))
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: {
                        ...
                        keys: ["enter"],
                        action: function () {
                            console.log(getCheckboxData("permission_form"));
    ...
    $(document).on("click", "button#userGroupEdit", function (clickEvent) {
        ...
        console.log(getIdSelections($("#users")));
        $.confirm({
            title: "لیست خرید",
            ...
            buttons: {
                confirm: {
                    ...
                    btnClass: "btn-green",
                    action: function () {
                        postData("users/update_selected_users", "POST", getFormData("userGEditForm", {

        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                $this.popover({
                    ...
                    title: 'انتخاب تاریخ',
                    trigger: 'manual',
                    template: '<div class="popover" role="tooltip" id="dtpop"><div class="arrow"></div><h3 class="popover-header" data-name="Md-DateTimePicker-Title"></h3><div class="popover-body"  data-name="Md-DateTimePicker-PopoverContent"></div></div>',
    ...
    function createDateTimePickerHtml($popoverDescriber, dateTimeInJsonFormat, writeDateString) {
        ...
        for (i = 1; i <= numberOfDaysInCurrentMonth; i++) {
            ...
            if (i == currentDay && dateTimeInJsonFormat.Month == currentMonth && dateTimeInJsonFormat.Year == currentYear) { // امروز
                $td = $('<td data-name="today" class="bg-success text-light" />').html(dayNumberInString);
            ...
            if (fromDateToDateJson != undefined &&
                ...
                if (!$td.hasClass('bg-success text-light'))

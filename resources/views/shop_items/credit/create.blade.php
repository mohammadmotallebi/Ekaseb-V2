<form method="post" id="ShopItemCreditForm" class="was-validated">
    <div class="form-group row">
        <label for="item_credit" class="col-3 col-form-label">@lang('lang.discount')</label>
        <div class="col-8">
            <input id="item_credit" money name="item_credit" type="text" class="form-control" autocomplete="off"
                   required>
        </div>
    </div>
    <div class="form-group row">

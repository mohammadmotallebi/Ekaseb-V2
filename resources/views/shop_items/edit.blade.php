    ...
    <div class="col-6">
        <form method="patch" id="ShopItemsEditForm" class="was-validated">
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input id="item_name" name="item_name" type="text" class="form-control" autocomplete="off"
                           value="{{ $shopitem->item_name }}" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="item_count" class="col-sm-2 col-form-label">{{ __('lang.count') }}</label>
                <div class="input-group col-sm-10">
                    <input id="item_count" type="text" class="form-control" autocomplete="off" value="{{ $count }}"
                           readonly>
                    <div class="input-group-append">
                        <button class="btn btn-success btn-sm" id="add_count"
                                type="button">{!! __('lang.addButton') !!}</button>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                    <select id="item_supplier_id" name="item_supplier_id" class="custom-select" required>
                        ...
                        @foreach($supplier as $x)
                            <option value="{{$x->id}}"
                                    @if($x->id === $shopitem->item_supplier_id) selected @endif>{{$x->item_supplier}}</option>
                        @endforeach
                    </select>
                    <div class="input-group-append">
                        <button class="btn btn-success btn-sm" id="add_supplier"
                                type="button">{!! __('lang.addButton') !!}</button>
                        <button class="btn btn-primary btn-sm" id="edit_supplier"
                                type="button">{!! __('lang.editButton') !!}</button>
                ...
                <div class="input-group col-sm-10">
                    <select id="item_cat_id" name="item_cat_id" class="custom-select" required>
                        ...
                        @foreach($category as $x)
                            <option value="{{$x->id}}"
                                    @if($x->id == $shopitem->item_cat_id) selected @endif>{{$x->item_category}}</option>
                        @endforeach
                    </select>
                    <div class="input-group-append">
                        <button class="btn btn-success btn-sm" id="add_category"
                                type="button">{!! __('lang.addButton') !!}</button>
                        <button class="btn btn-primary btn-sm" id="edit_category"
                                type="button">{!! __('lang.editButton') !!}</button>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                    <select id="item_type_id" name="item_type_id" class="custom-select" required>
                        @foreach($types as $x)
                            <option value="{{$x->id}}"
                                    @if($x->id == $shopitem->item_type_id) selected @endif>{{$x->item_type}}</option>
                        @endforeach
                    </select>
                    <div class="input-group-append">
                        <button class="btn btn-success btn-sm" id="add_type"
                                type="button">{!! __('lang.addButton') !!}</button>
                        <button class="btn btn-primary btn-sm" id="edit_type"
                                type="button">{!! __('lang.editButton') !!}</button>
            ...
            <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                    <select id="item_model_id" name="item_model_id" class="custom-select" required>
                        @foreach($models as $x)
                            <option value="{{$x->id}}"
                                    @if($x->id == $shopitem->item_model_id) selected @endif>{{$x->item_model}}</option>
                        @endforeach
                    </select>
                    <div class="input-group-append">
                        <button class="btn btn-success btn-sm" id="add_model"
                                type="button">{!! __('lang.addButton') !!}</button>
                        <button class="btn btn-primary btn-sm" id="edit_model"
                                type="button">{!! __('lang.editButton') !!}</button>
            ...
            <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                    <select id="item_size_id" name="item_size_id" class="custom-select" required>
                        @foreach($sizes as $x)
                            <option value="{{$x->id}}"
                                    @if($x->id == $shopitem->item_size_id) selected @endif>{{$x->item_size}}</option>
                        @endforeach
                    </select>
                    <div class="input-group-append">
                        <button class="btn btn-success btn-sm" id="add_size"
                                type="button">{!! __('lang.addButton') !!}</button>
                        <button class="btn btn-primary btn-sm" id="edit_size"
                                type="button">{!! __('lang.editButton') !!}</button>
            ...
            <div class="form-group row">
                ...
                <div class="input-group col-sm-10">
                    <select id="item_color_id" name="item_color_id" class="custom-select" required>
                        ...
                        @foreach($color as $x)
                            <option value="{{$x->id}}"
                                    @if($x->id == $shopitem->item_color_id) selected @endif>{{$x->item_color}}</option>
                        @endforeach
                    </select>
                    <div class="input-group-append">
                        <button class="btn btn-success btn-sm" id="add_color"
                                type="button">{!! __('lang.addButton') !!}</button>
                        <button class="btn btn-primary btn-sm" id="edit_color"
                                type="button">{!! __('lang.editButton') !!}</button>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input id="item_note" name="item_note" type="text" class="form-control"
                           value="{{$shopitem->item_note}}" autocomplete="off" required>
                </div>
            </div>
        </form>
    </div>
    <div class="col-6 border-right-primary">
        ...
        >
            ...
            <tr>
                ...
                <th data-sortable="true" data-formatter="priceFormatter"
                    data-field="item_price">{{ __('lang.price') }}</th>
        ...
        >
            ...
            <tr>
                <th data-radio="true"></th>
                <th data-sortable="true" data-formatter="priceFormatter"
                    data-field="item_credit">{{ __('lang.discount') }}</th>

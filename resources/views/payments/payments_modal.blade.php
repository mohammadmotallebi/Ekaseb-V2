<div class="alert alert-info">
    <b> @lang('lang.contract_number')</b> : <b dir="ltr"> {{ $res->contract_unique_id }} </b>
</div>
<div class="row">
    <div class="col-6">
        ...
        <form method="post" id="contractForm" class="was-validated" autocomplete="off">
            <div class="form-group row">
                <label class="col-2 col-form-label">{{ __('lang.rent') }}</label>
                <div class="col-12 col-md-8">
                    <input id="rent" dir="ltr" name="rent" type="text" money title="{{ __('lang.rent') }}" data-toggle="tooltip"
                           class="form-control text-center" value="{{ number_format($res->rent) }}" placeholder="{{ __('lang.rent') }}"
                           autocomplete="off" readonly>
                </div>
{{--                <div class="col-12 col-md-4">--}}
{{--                    <input id="charge" name="charge" dir="ltr" type="text" money title="{{ __('lang.charge') }}"--}}
{{--                           data-toggle="tooltip" value="{{ number_format($res->charge) }}" class="form-control text-center"--}}
...
{{--                </div>--}}
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <select id="renter_id" name="renter_id" class="custom-select" disabled>
                            <option
                                value="{{$res->renter_id}}" selected="selected" >{{ $res->renter_name }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-4">
                    <input id="start_date" name="start_date"  type="text" class="form-control"
                           ...
                           autocomplete="off" value="{{ $res->start_date }}" placeholder="{{ __('lang.of') }}" readonly>
                </div>
                <div class="col-12 col-md-4">
                    <input id="end_date" name="end_date" title="{{ __('lang.end_date') }}"
                           type="text" class="form-control" data-MdDateTimePicker="true"
                           autocomplete="off" value="{{ $res->end_date }}" placeholder="{{ __('lang.until') }}" readonly>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-12 col-md-4">
                    <div class="input-group">
                        <input id="deposit" name="deposit" dir="ltr" data-toggle="tooltip" type="text"
                               title="{{ '<b>'.__('lang.deposit').'</b>' }}" value="{{ number_format($res->deposit) }}" class="form-control text-center"
                ...
                <div class="col-12 col-md-4">
                    <div class="input-group">
                        <input id="rent_price_monthly" name="rent_price_monthly" dir="ltr" type="text" class="form-control text-center"
                               data-toggle="tooltip" value="{{ number_format($res->rent_monthly) }}" placeholder="{{ __('lang.rent_price_monthly') }}" money
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-4">
                    <input id="deposit_discount" dir="ltr" name="deposit_discount" type="text" money
                           ...
                           title="{{ __('lang.deposit_discount') }}" value="{{ number_format($res->deposit_discount) }}" data-toggle="tooltip" autocomplete="off" readonly/>

                </div>
                <div class="col-12 col-md-4">
                    <input id="rent_discount" dir="ltr" name="rent_discount" type="text"
                           placeholder="{{ __('lang.rent_discount') }}" value="{{ number_format($res->rent_discount) }}" title="{{ __('lang.rent_discount') }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-12 col-md-4">
                    <input id="end_deposit" name="end_deposit" type="text"
                           placeholder="{{ __('lang.deposit_end') }}" value="{{ number_format($res->end_deposit) }}" class="form-control"
...
{{--                           title="{{ __('lang.charge_yearly') }}" value="{{ number_format($res->charge_yearly) }}" placeholder="{{ __('lang.charge_yearly') }}"--}}
{{--                           class="form-control text-center" money--}}
{{--                           readonly/>--}}
{{--                </div>--}}
                <div class="col-12 col-md-4">
                    <input id="end_rent" name="end_rent" type="text" dir="ltr"
                           placeholder="{{ __('lang.rent_end') }}" value="{{ number_format($res->end_rent_monthly) }}" title="{{ __('lang.rent_end') }}"
                           data-toggle="tooltip" class="form-control text-center"
                           readonly/>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-2 col-form-label">{{ __('lang.rent_price_yearly') }}</label>


                <div class="col-12 col-md-8">
                    <input id="rent_yearly" name="rent_yearly" dir="ltr" value="{{ number_format($res->rent_yearly) }}" type="text" data-toggle="tooltip"

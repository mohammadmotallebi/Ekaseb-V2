<form method="post" id="PaymentReasonForm" class="was-validated">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="reason" name="reason" type="text" class="form-control" value="{{ $res->reason }}" autocomplete="off" required>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row justify-content-md-center mt-2">
        <div class="col-md-10">
            ...
            <label class="boxed-check">
                <input class="boxed-check-input" type="checkbox" name="for_contract" onclick="checkboxSetValue(this)" @if($res->for_contract == 1) checked @endif>

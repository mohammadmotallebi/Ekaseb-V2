<form method="post" id="userForm" class="was-validated">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="father" name="father" type="text" class="form-control" value="{{ $user->father }}"
                   autocomplete="off" required>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="mobile_back" name="mobile_back" type="text" class="form-control" value="{{ $user->mobile_back }}"
                   autocomplete="off" required>
        </div>
    </div>
    <div class="form-group row">

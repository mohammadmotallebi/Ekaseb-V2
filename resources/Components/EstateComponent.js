        ...
        'click #view': function (e, value, row, index) {
            $.confirm({
                ...
                onContentReady: function () {
                    ...
                    const td = row.total_rent_monthly;

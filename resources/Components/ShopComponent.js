...
shopsRender = () => {
    ...
    function addItems() {
        addQuickly(
            "#add_supplier",
            "ShopItemSupplier/create",
            "ShopItemSupplier/store/" + rowID,
            "ShopItemSupplierForm",
            "#item_supplier_id",
            "get-item-suppliers/" + rowID
        );
        addQuickly(
            "#add_color",
            "ShopItemColor/create",
            "ShopItemColor/store",
            "ShopItemColorForm",
            "#item_color_id",
            "get-item-colors-select"
        );
        addQuickly(
            "#add_category",
            "ShopItemCategories/create",
        ...
        addQuickly(
            ...
            (e) => {
                ...
                e.onClose = () => {
                    postData(
                        "get-item-models/" + $("#item_type_id").val(),
                        "POST"
                    )
                        .then((res) => res.json())
                        .then((d) => {
        ...
        addQuickly(
            ...
            (e) => {
                ...
                e.onClose = () => {
                    postData(
                        "get-item-sizes/" + $("#item_type_id").val(),
                        "POST"
                    )
                        .then((res) => res.json())
                        .then((d) => {
    ...
    function editItems() {
        editQuickly(
            "#edit_supplier",
            "ShopItemSupplier/edit",
            "ShopItemSupplier/update",
            "ShopItemSupplierForm",
            "#item_supplier_id",
            "get-item-suppliers/" + rowID,
            function (e) {
        ...
        editQuickly(
            "#edit_category",
            "ShopItemCategories/edit",
            "ShopItemCategories/update",
            "ShopItemCategoriesForm",
            "#item_cat_id",
            "get-ShopItemCategories-select",
            function (e) {
    ...
    function deleteItems() {
        ...
        deleteQuickly(
            ...
            "itemColor/destroy",
            "#item_color_id",
            "get-ShopItemColors-select"
        );
        deleteQuickly(
            "#delete_supplier",
            "ShopItemSupplier/destroy",
            "#item_supplier_id",
            "get-item-suppliers/" + rowID
        );
    }
                    ...
                    confirm: {
                        ...
                        action: function () {
                            postData(
                                "ShopItems/update",
                                "PATCH",
                                getFormData("ShopItemsEditForm", { id: itemID })
                            ).then((data) => {
    ...
    $("button#addChildItem").click(function (clickEvent) {
        ...
        $.confirm({
                ...
                confirm: {
                    ...
                    action: function () {
                        postData(
                            "ShopItems/store",
                            "post",
                            getFormData("ShopItemsForm", { id: rowID })
                        ).then((data) => {
                            $child.bootstrapTable("refresh");
                            notificationAddSuccess();
                        });
            ...
            onContentReady: function () {
                ...
                modalSettings();
                $(document).on("change", "#item_count", (e) => {
                                ...
                                confirm: {
                                    ...
                                    action: function () {
                                        postData(
                                            "item-credits/store",
                                            "POST",
                                            getFormData("ShopItemCreditForm", {
                                                unique_code: unique_code,
                                            })
                                        )
                                            .then((res) => res.json())
            ...
            onClose: function () {
                // fetch("destroy-null/" + unique_code);
            },
        });
    });
        ...
        var add_multi = $.confirm({
            ...
            buttons: {
                confirm: {
                    ...
                    action: function () {
                        postData(
                            "ShopItems/store-multi",
                            "post",
                            getFormData("add-multi-item", { id: rowID })
                        )
                            .then((response) => response.json())
                            .then((data) => {
                                $child.bootstrapTable("refresh");
        ...
        $.confirm({
            ...
            buttons: {
                confirm: {
                    ...
                    action: function () {
                        postData(
                            "ShopItems/update-multi",
                            "post",
                            getFormData("edit-multi-item", { id: rowID })
                        )
                            .then((response) => response.json())
                            .then((data) => {
                                if (data == 1) {
